...
import { ChevronLeft, Calendar, Target, Users, DollarSign, MapPin, Globe } from "lucide-react"
        ...
        <div className="bg-white rounded-xl shadow-sm border p-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="space-y-1">
              ...
              <p className="text-gray-900 font-medium capitalize">{campaign.adGoal}</p>
            </div>
          </div>
        </div>
          ...
          {campaign.campaignType === "ppv" && (
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">₦{parseFloat(campaign.perViewAmount).toLocaleString()}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">View Goal</span>
                <span className="font-semibold">{parseInt(campaign.viewGoal).toLocaleString()} views</span>
              </div>
            </div>
          )}
          ...
          {campaign.campaignType === "ppi" && (
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">₦{parseFloat(campaign.perInfluencerAmount).toLocaleString()}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Influencer Count</span>
                <span className="font-semibold">{campaign.influencerCount.toLocaleString()}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Total Amount</span>
                <span className="font-semibold">₦{parseFloat(campaign.amountToSpend).toLocaleString()}</span>
              </div>
            </div>
          )}
        </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{campaign.targetingRules.ageRange}</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{campaign.targetingRules.location}</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium capitalize">{campaign.targetingRules.preferredGender}</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{campaign.targetingRules.language}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-4">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium uppercase">{campaign.campaignType}</span>
            </div>
            <div className="flex justify-between">
